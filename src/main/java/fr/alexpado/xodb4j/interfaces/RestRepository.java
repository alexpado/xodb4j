 ...
 * separately.
 * <p>
 * Every request may fail if two or more entity share the same identifier, meaning that serious bug could occur in any
...
public interface RestRepository<T extends Identifiable<ID>, ID> {
    ...
    /**
     * Retrieve every entity of the current type having their identifier contained in the provided {@link Iterable}.
     *
     * @param ids
